        ...
        <div className={footerStyles.content}>
          <div className={footerStyles.top}>
            ...
            <div className={footerStyles[`media-icons`]}>
              ...
              <Link href="https://imdbabhi.vercel.app/">
                <i>
                  {" "}
                  <FaImdb />{" "}
                </i>{" "}
              </Link>
              <Link href="https://github.com/Abhisheklips">
                <i>
                  {" "}
                  <FaGithub />{" "}
                </i>{" "}
              ...
              <Link href="https://www.instagram.com/__abhishek_c_v/">
                <i>
                  {" "}
                  <FaInstagram />{" "}
                </i>
              </Link>
              <Link href="https://www.linkedin.com/in/abhishek-c-v/">
                <i>
                  {" "}
                  <FaLinkedinIn />{" "}
                </i>
              </Link>
              <Link href="https://www.youtube.com/@geekcv625">
                <i>
                  {" "}
                  <FaYoutube />{" "}
                </i>
        ...
        <div className={footerStyles["bottom-details"]}>
          <div className={footerStyles.bottom_text}>
            <span className={footerStyles.copyright_text}>
              {" "}
              Copyright © 2024
              <Link href="https://geekcvtech.blogspot.com/?m=1">
                {" "}
                Geek CV{" "}
              </Link>{" "}
              All rights reserved{" "}
